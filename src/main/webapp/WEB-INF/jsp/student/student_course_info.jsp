            ...
            <div class="panel panel-default">
                ...
                <table class="table">
                        ...
                        <td>
                            <c:choose>
                                ...
                                <c:when test="${course.status == 'NOT_STARTED'}">
                                    <span class="label label-error">${not_started}</span>
                                </c:when>
                    ...
                    <c:if test="${sessionScope.review != null}">
                        <tr>
                            <td><b>${mark}:</b></td>
                            <td><b>${sessionScope.review.mark}</b></td>
                        </tr>
                    </c:if>
                </table>
                <c:if test="${course.status == 'OPEN_SET'}">
                    <div class="panel-footer">
                        <c:choose>
                            <c:when test="${sessionScope.isSigned}">
                                <h4><span class="label label-primary">${applied}</span></h4>
                            </c:when>
                            <c:otherwise>
                                <form action="/Controller" method="post">
                                    <input type="hidden" name="command" value="apply-for-course"/>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <table class="table">
                    <tr>
                        <td>${fullname}:</td>
                        <td>${sessionScope.teacher.secondname}
                            ${sessionScope.teacher.firstname}
                            ${sessionScope.teacher.thirdname}
                        </td>
                    </tr>
                    <tr>
                        <td>${university}:</td>
                        <td>${sessionScope.teacher.university}</td>
                    </tr>
                    <tr>
                        <td>${faculty}:</td>
                        <td>${sessionScope.teacher.faculty}</td>
                    </tr>
                    <tr>
                        <td>${phone}:</td>
