...
<head>
    ...
    <title>Teacher | Add review</title>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="/Controller" method="post">
                        <input type="hidden" name="command" value="add-student-review"/>
                        ...
                        <div class="form-group">
                            <label for="mk">${mark}:</label>
                            <input type="number" class="form-control" name="mark" id="mk">
                        </div>
                        <div class="form-group">
                            <label for="rv">${review}:</label>
                            <textarea class="form-control" name="text" id="rv" style="height: 100px"></textarea>
                        </div>
                        <div class="form-group">
