...
<head>
    ...
    <title>Teacher | Course info</title>
    ...
    <fmt:message bundle="${loc}" key="local.teacher.reviewed" var="reviewed" />
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">${student_list}</div>
                        ...
                        <c:forEach items="${sessionScope.studentList}" var="student">
                            <div class="list-group">
                                <form action="/Controller" method="post">
                                    ...
                                    <c:choose>
                                        <c:when test="${course.status == 'COMPLETED' && !student.reviewed}">
                                            <input type="hidden" name="command" value="get-add-review-form"/>
                                        </c:when>
                                        <c:otherwise>
                                    ...
                                    <a type="submit" href="" onclick="this.parentNode.submit(); return false;" class="list-group-item">
                                        ...
                                        ${student.firstname}
                                        ${student.thirdname}
                                            <c:if test="${course.status == 'COMPLETED' && student.reviewed}">
