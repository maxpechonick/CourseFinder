...
<head>
    ...
    <fmt:message bundle="${loc}" key="local.admin.new_course" var="new_course" />
        ...
        <div class="col-md-offset-2 col-md-8">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="list-group" style="height: 450px;overflow-y: auto;">
                        <c:forEach items="${sessionScope.allCourses}" var="course">
                            <div class="list-group">
                                <form action="/Controller" method="post">
                                    ...
                                    <input type="hidden" name="command" value="get-admin-course-info"/>
                        ...
                        <form action="/Controller" method="post" style="text-align: center">
                            ...
                            <input type="hidden" name="command" value="admin-get-more-courses"/>
                            <button type="submit" class="btn btn-link">
                ...
                <div class="panel-footer">
                    <form action="/Controller" method="post">
                        <input type="hidden" name="command" value="get-create-course-form"/>
                        <button type="submit" class="btn btn-primary">${new_course}</button>
                    </form>
                </div>
            </div>
        </div>
