...
<head>
  ...
  <title>Registration page</title>
    ...
    <fmt:message bundle="${loc}" key="local.create.message" var="create" />
    <fmt:message bundle="${loc}" key="local.exist.message" var="exist" />
    ...
    <div class="container">
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                <div class="panel-heading">${reg}</div>
                    ...
                    <form action="Controller" method="POST" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <span class="input-group-btn">
                                <span>
                                    <button type='submit' id='register-button' class='btn btn-success btn-large pull-right' >${registration}</button>
                                </span>
                            </span>
                    </form>
                        <span>
                            <form action="Controller" role="form" method="post">
                                ...
                                <button type="submit" class="btn btn-link pull-left">${login}</button>
                            </form>
                        </span>
                </div>
            </div>
